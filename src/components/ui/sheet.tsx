	...
	return (
		<SheetPortal>
			...
			<SheetPrimitive.Content
				...
				className={cn(
					"fixed z-50 flex flex-col gap-4 bg-background shadow-lg transition-[transform,opacity] ease-[var(--ease-drawer)] data-[state=closed]:animate-out data-[state=closed]:duration-[var(--duration-drawer-close)] data-[state=open]:animate-in data-[state=open]:duration-[var(--duration-drawer-open)]",
					side === "right" &&
